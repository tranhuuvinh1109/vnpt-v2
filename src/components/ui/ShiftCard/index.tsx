    ...
    <div className="rounded-lg bg-white p-2 shadow-2xl">
      <div className="flex items-center justify-between hover:cursor-pointer" onClick={toggleShift}>
        <div className="flex items-center gap-2">
          ...
          {label && (
            <div className="bg-element-main hidden h-fit justify-center rounded-full px-2 py-0.5">
      ...
      <div className={`${isOpen ? "" : "hidden"} mt-2 border-t border-t-slate-400 py-2`}>
        ...
        {!isEditMode ? (
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-1 items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="relative flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 p-2">
                  <div className="relative h-4 w-4">
                    <Image alt="assign_user" src="/images/default-avatar.png" fill />
                  </div>
                </div>
                <h6>Nguyễn Văn A</h6>
              </div>
        ...
        {!isEditMode && (
          <div className="flex flex-col gap-10">
            ...
            {data.infor_during && (
              <ShiftInfo data={data.infor_during} title="Thông tin quá trình" />
            )}
