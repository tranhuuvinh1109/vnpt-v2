...
export const DateCard = ({ data, isActive, onClick }: DateCardProps) => {
  return (
    <div
      className={`flex min-w-14 flex-col items-center gap-1 rounded-2xl border px-2 py-4 shadow-lg hover:cursor-pointer ${isActive ? "bg-element-main text-white" : "bg-white text-gray-500"}`}
